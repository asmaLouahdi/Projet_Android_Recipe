    ...
    public class FavorisAdapter extends RecyclerView.Adapter<FavorisAdapter.MyViewHolder> {
        ...
        public FavorisAdapter(List<Recette> recettes, Context context) {
            super();
        ...
        public List<String> getFavoris(){
            ...
            Log.d("taille", "getFavoris: "+data.getCount());
            while(data.moveToNext()){
                list.add(data.getString(0));
            }
            return list;
        }
        public int getIndex(List<String> favorites, String id){
